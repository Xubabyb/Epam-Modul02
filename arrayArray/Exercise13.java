...
public class Exercise13 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Отсортированный массив с элементами столбца по убыванию:");

		matrix = findMaxAndSort(matrix);
		printArray(matrix);

		System.out.println("Отсортированный массив с элементами столбца по возрастанию:");
